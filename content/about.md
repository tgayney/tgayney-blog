...
I have a particular interest in **virtualization**, **VPN technologies**, and **network automation**—areas I believe are critical to building efficient, scalable, and secure modern infrastructures. I enjoy exploring how these technologies intersect to improve connectivity, streamline operations, and enhance security across enterprise environments.

This blog serves as both a **portfolio** and a **learning journal**, where I share my experiences completing **network solutions**, **packet capture labs**, and **case studies**. My goal is to showcase my technical growth while contributing to the broader IT community by sharing insights, challenges, and solutions that others might find valuable. For me, IT isn’t just a job — it’s about continuous learning, problem-solving, and innovation.
